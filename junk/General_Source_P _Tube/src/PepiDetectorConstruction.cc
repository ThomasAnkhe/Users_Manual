...
void PepiDetectorConstruction::DefineVolumes()
{
  ...
  fWorldSolid = new G4Box("World",                         // World's name.
                          fWorldSizeX/2,                   // World's size.
                          fWorldSizeY/2,
                          fWorldSizeZ/2);          
...
// ================================================================================
//                    BEGINING OF THE MANUAL'S OBJECTS CREATION
// ================================================================================
...
fSphere2Solid = new G4Tubs("Tube", 1*mm, 2*mm, 5*cm/2, 0, 2*pi);

fSphere2Logical = new G4LogicalVolume(fSphere2Solid,fMicroSphereMaterial,"TubeLV");

G4ThreeVector objectPositionTube = G4ThreeVector(fTrans + fDith, 0, fSourcePosZ+fSrcObjDistance);
...
// - Stepping and Dithering of the sample -:
  ...
  //Move("Sphere3", fMicroSphereLogical3, fMicroSpherePhysical3, position6, fWaxInsertLogical);

  // - Object 7 - Nylon Tube

  //G4ThreeVector position7 = G4ThreeVector(fTrans + fDith, 0, fSourcePosZ+fSrcObjDistance);
  //Move("Tube", fSphere2Logical, fSphere2Physical, position7, fWorldLogical);
