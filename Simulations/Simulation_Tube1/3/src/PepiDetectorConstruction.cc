...
fMuscleLogical = new G4LogicalVolume(fMuscleSolid,fMuscleMaterial, //PMMA 
             "TubeLV2");
                                                                          
G4ThreeVector objectPosition = G4ThreeVector(0*mm, 0, fSourcePosZ+fSrcObjDistance); 

fMusclePhysical = new G4PVPlacement(rotMat4,              //its rotation
                                    objectPosition,       //its translation
                                    fMuscleLogical,      //its logical volume
                                    "tube2",              //its name
                                    fWorldLogical,       //its mother volume
                                    false,               //no boolean operation
                                    0,                   //copy number
